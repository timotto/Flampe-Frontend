...
angular
  ...
  .config(['$routeProvider','$mdIconProvider','$translateProvider',function ($routeProvider,$mdIconProvider,$translateProvider) { // $mdThemingProvider
    ...
    $mdIconProvider
      ...
      .icon('gesture', 'images/ic_gesture_black_24px.svg', 24)
      .icon('filter_list', 'images/ic_filter_list_black_24px.svg', 24)
      .icon('color_lens', 'images/ic_color_lens_black_24px.svg', 24)
      .icon('color_lens_white', 'images/ic_color_lens_white_24px.svg', 24)
      .icon('brightness_medium', 'images/ic_brightness_medium_black_24px.svg', 24)
      .icon('cloud', 'images/ic_cloud_black_24px.svg', 24)
      .icon('linear_scale', 'images/ic_linear_scale_black_24px.svg', 24)
      .icon('menu', 'images/ic_menu_black_24px.svg', 24)
      .icon('share', 'images/ic_share_black_24px.svg', 24)
      .icon('email', 'images/ic_email_black_24px.svg', 24)
